...
### 1.9 BTN2 니블 리드아웃 (보조 — 이제 거의 쓸 일 없음)
...
- ~~패턴 1·2·3, 모드 2·3~~ → ✅ 실물 전수 순회 완료(§1.8)
- ~~`2'b11` 0건~~ → ✅ `Z=0000` (실물·시뮬 양쪽)
- 미검증: **`EPD_SD[15:0]`의 픽셀 값 자체**(기하 구조 포함),
  `make demo`(PANEL_TEST), 웨이브폼 LUT/그레이스케일 정확도
